                ...
                <div class="table-responsive">
                    <table class="table">
                        <thead class="text-fs-4">
                            ...
                            <th scope="col">Description & VIN</th>
                        ...
                        <tbody>
                            <tr class="align-middle overflow-hidden shadow mb-2">
                                ...
                                <td>
                                    <a href="/user/vehicles/1?1" class="fw-bold text-fs-5">
                                        Ford Explorer XLT
                                    </a>
                                    <p class="text-muted ext-fs-4">5NPLM4AG6NH054918</p>
                                </td>
                                <td>
                                    ...
                                    <div class="flex items-center justify-center flex-col comment"
                                        ...
                                        <div class="border border-1 d-flex flex-column align-items-end">
                                            <p class="text-fs-3 m-0">
                                                Brand new car , just a small scratch on left door
                                            </p>
