            ...
            <div class="modal-dialog rounded-5">
                <div class="modal-content p-3">
                    ...
                    <div class="modal-body">
                        <form action="{{ url('user/add-sub-user') }}" method="POST" class="user-form">
                            @csrf
                            <div class="row mt-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group shadow-lg rounded-4">
                                                ...
                                                <input type="text" name="name" value="" class="py-2 form-control rounded-end-4" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group shadow-lg rounded-4">
                                                ...
                                                <div class="input-group-text rounded-end-4" style="width: 80% !important; height: 40px !important;">
                                                    <input name="phone" type="text" id="buyer-phone" class="form-control rounded-end-4 border-0" placeholder="Enter Number" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
