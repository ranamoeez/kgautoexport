                        ...
                        <div class="row mt-5">
                            <div class="col">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="row shadow border rounded-5 w-10 mb-3 py-4">
                                        <span class="col text-fs-3 text-center">2023 Toyota Land cruiser
                                            LC300</span>
                                        <span class="col text-fs-3 text-center">PK83672B760749348</span>
                                        <span class="col text-fs-3 text-center">1873 kg</span>
                                    </div>
                                    <div class="row shadow border rounded-5 w-10 mb-3 py-4">
                                        <span class="col text-fs-3 text-center">2023 Toyota Land cruiser
                                            LC300</span>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <span class="col text-fs-3 fw-bold text-center">Total 4 units</span>
                                        <span class="col text-fs-3 fw-bold text-center">7492 kg</span>
                                    </div>
                                </div>
